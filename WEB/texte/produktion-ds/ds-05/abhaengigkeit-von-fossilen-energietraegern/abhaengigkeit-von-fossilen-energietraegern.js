...
async function loadExplanations() {
  try {
    const response = await fetch('abhaengigkeit-von-fossilen-energietraegern-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "abhaengigkeit-von-fossilen-energietraegern-flashcards.html";
    });
  }
