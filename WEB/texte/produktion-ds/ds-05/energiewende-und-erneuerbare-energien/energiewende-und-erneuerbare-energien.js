...
async function loadExplanations() {
  try {
    const response = await fetch('energiewende-und-erneuerbare-energien-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "energiewende-und-erneuerbare-energien-flashcards.html";
    });
  }
