...
async function loadExplanations() {
  try {
    const response = await fetch('schlafmangel-und-leistungsfaehigkeit-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "schlafmangel-und-leistungsfaehigkeit-flashcards.html";
    });
  }
