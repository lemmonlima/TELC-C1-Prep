...
async function loadExplanations() {
  try {
    const response = await fetch('diskriminierung-und-chancengleichheit-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "diskriminierung-und-chancengleichheit-flashcards.html";
    });
  }
