...
async function loadExplanations() {
  try {
    const response = await fetch('anerkennung-auslaendischer-abschluesse-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "anerkennung-auslaendischer-abschluesse-flashcards.html";
    });
  }
