...
async function loadExplanations() {
  try {
    const response = await fetch('politische-partizipation-junger-menschen-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "politische-partizipation-junger-menschen-flashcards.html";
    });
  }
