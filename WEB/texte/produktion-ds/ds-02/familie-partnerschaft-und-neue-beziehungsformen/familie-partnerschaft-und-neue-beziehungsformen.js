...
async function loadExplanations() {
  try {
    const response = await fetch('familie-partnerschaft-und-neue-beziehungsformen-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "familie-partnerschaft-und-neue-beziehungsformen-flashcards.html";
    });
  }
