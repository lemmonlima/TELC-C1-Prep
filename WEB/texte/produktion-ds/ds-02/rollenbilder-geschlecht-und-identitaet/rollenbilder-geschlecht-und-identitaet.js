...
async function loadExplanations() {
  try {
    const response = await fetch('rollenbilder-geschlecht-und-identitaet-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "rollenbilder-geschlecht-und-identitaet-flashcards.html";
    });
  }
