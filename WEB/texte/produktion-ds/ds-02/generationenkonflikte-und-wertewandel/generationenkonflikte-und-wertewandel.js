...
async function loadExplanations() {
  try {
    const response = await fetch('generationenkonflikte-und-wertewandel-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "generationenkonflikte-und-wertewandel-flashcards.html";
    });
  }
