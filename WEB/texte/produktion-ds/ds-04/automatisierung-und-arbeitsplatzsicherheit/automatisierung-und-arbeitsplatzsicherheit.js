...
async function loadExplanations() {
  try {
    const response = await fetch('automatisierung-und-arbeitsplatzsicherheit-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "automatisierung-und-arbeitsplatzsicherheit-flashcards.html";
    });
  }
