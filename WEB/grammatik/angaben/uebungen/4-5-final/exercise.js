...
const exerciseLabels = {
  "35": "35. Formen Sie um! Bilden Sie Finalsätze!",
  "36": "36. Formen Sie um! Bilden Sie Sätze mit \"sonst\" oder \"andernfalls\"!",
  "37": "37. Formen Sie die folgenden Sätze um! Bilden Sie Finalsätze!"
};
...
function removeSemanticTags(text) {
  return text.replace(/\{ang-final:([^}]+)\}/g, "$1");
}
...
function updateExerciseSelect() {
  ...
  // Show exercises 35, 36, 37
  const allowedExercises = ["35", "36", "37"];
