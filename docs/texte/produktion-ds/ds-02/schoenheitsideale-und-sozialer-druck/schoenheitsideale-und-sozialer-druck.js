...
async function loadExplanations() {
  try {
    const response = await fetch('schoenheitsideale-und-sozialer-druck-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "schoenheitsideale-und-sozialer-druck-flashcards.html";
    });
  }
