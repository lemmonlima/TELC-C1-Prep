...
async function loadExplanations() {
  try {
    const response = await fetch('psychische-gesundheit-und-praevention-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "psychische-gesundheit-und-praevention-flashcards.html";
    });
  }
