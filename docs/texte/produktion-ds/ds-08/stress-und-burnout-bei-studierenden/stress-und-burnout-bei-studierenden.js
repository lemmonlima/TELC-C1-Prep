...
async function loadExplanations() {
  try {
    const response = await fetch('stress-und-burnout-bei-studierenden-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "stress-und-burnout-bei-studierenden-flashcards.html";
    });
  }
