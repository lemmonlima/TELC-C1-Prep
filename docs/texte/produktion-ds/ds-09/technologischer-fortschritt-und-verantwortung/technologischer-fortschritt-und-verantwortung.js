...
async function loadExplanations() {
  try {
    const response = await fetch('technologischer-fortschritt-und-verantwortung-explanations.json', { cache: 'no-store' });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flashcardsBtn) {
    flashcardsBtn.addEventListener("click", () => {
      window.location.href = "technologischer-fortschritt-und-verantwortung-flashcards.html";
    });
  }
