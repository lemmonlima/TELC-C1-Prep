...
const exerciseLabels = {
  "38": "38. Bilden Sie Konzessivsätze!",
  "39": "39. Formen Sie um! Bilden Sie Sätze mit \"trotzdem\" oder \"dennoch\"!",
  "40": "40. Formen Sie um! Bilden Sie nominale Konzessiv-Angaben mit \"trotz\"!"
};
...
function removeSemanticTags(text) {
  return text.replace(/\{ang-konz:([^}]+)\}/g, "$1");
}
...
function updateExerciseSelect() {
  ...
  // Show exercises 38, 39, 40
  const allowedExercises = ["38", "39", "40"];
